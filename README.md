...
### Software Engineer | Full Stack Developer | 2+ Years Experience

- 🚀 2+ Years of Professional Experience in building scalable web applications.
- 🎓 Alumnus: CSE Undergraduate at MANIT Bhopal.
- 🛠️ Current Focus: Advanced Backend Architectures & Frontend Optimization.
- 📗 Passionate about Open Source collaboration and architectural best practices.
- ⚡ **Goal:** Bridging the gap between complex backend logic and seamless user experiences.
- 🛠  Languages - Python | C++ | C | JavaScript | Java | HTML | CSS | SQL
- 🧾[Download My Updated Resume](https://drive.google.com/file/d/1c8VbI1ovWLb71x5zaUPmmAjZtTBYbwfk/view?usp=sharing)
...
* **Collaboration:** I’m always open to discussing new projects or tech opportunities!
